...
public class MatrixService {
  ...
  public void overrideAdminRateLimit(String adminUserId) {
    try {
      ...
      int messagePerSecond = currentLimits.getElement("messages_per_second").getIntValue();
      int burstCount = currentLimits.getElement("burst_count").getIntValue();
      if (messagePerSecond > 0 || burstCount > 0) {
