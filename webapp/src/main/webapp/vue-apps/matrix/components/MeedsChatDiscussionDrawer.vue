      ...
      <div
        ...
        <div
          ...
          <meeds-chat-message
            ...
            @unseen-changed="isProgrammaticalScroll = true"
            @reply="replyToMessage"
            @reaction="reactToMessage"
            @reset-unseen="resetUnseenData(true)" />
...
export default {
  ...
  watch:{
    ...
    isTyping() {
      if (!this.isTyping) {
        this.isProgrammaticalScroll = true;
        requestAnimationFrame(() => {
          setTimeout(() => this.isProgrammaticalScroll = false, 200);
        })
      }
    }
  },
